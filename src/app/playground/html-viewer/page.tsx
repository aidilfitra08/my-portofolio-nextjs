      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-gray-400">
            Paste your HTML code and see it rendered instantly
          </p>
        </div>
